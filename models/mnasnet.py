...
class SeqConv(nn.Module):
    ...
    def __init__(self, in_chnls, out_chnls, kernel_size, activation=True):
        ...
        self.trans = BN_Conv2d(in_chnls, out_chnls, 1, 1, 0, activation=False)   # Linear activation
...
class MBConv(nn.Module):
    ...
    def __init__(self, in_chnls, out_chnls, kernel_size, expansion, stride, is_se = False,
        ...
        self.trans2 = BN_Conv2d(in_chnls*expansion, out_chnls, 1, 1, 0, activation=False)    # Linear activation
